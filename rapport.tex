...
\subsubsection*{Langage régulier ?}
Au vu de la forme des syzygies principales, et de l'algorithme pour en calculer de nouvelles, on peut se demander si un automate peut reconnaître les monômes dominants des syzygies.

Ce n'est malheureusement pas le cas.
Prenons $g_1 = sxe, g_2 = sye, g_3 = axa - x, g_4 = aya - a, g_5 = y - x$.
...
Par compatibilité à la multiplication à gauche et à droite, il suffit de montrer que les~:
$$(sa^n, 5, a^ne)$$
sont des monômes dominants de syzygies, ce qui est le cas car~:
$$(sa^n, 5, a^ne) + \sum_{k = 0}^{n - 1} (sa^k, 3, a^ke) + (1, 1, 1)
- \sum_{k = 0}^{n - 1} (sa^k, 4, a^ke) - (1, 2, 1)$$
\end{proof}
